 ...
 */
export type CocoKeypointName = 'nose' | 'left_eye' | 'right_eye' | 'left_ear' | 'right_ear' | 'left_shoulder' | 'right_shoulder' | 'left_elbow' | 'right_elbow' | 'left_wrist' | 'right_wrist' | 'left_hip' | 'right_hip' | 'left_knee' | 'right_knee' | 'left_ankle' | 'right_ankle';
...
export declare const COCO_KEYPOINT_NAMES: readonly CocoKeypointName[];
/** Vision-only joints appended after the COCO-aligned 17. */
export declare const VISION_EXTRA_KEYPOINT_NAMES: readonly VisionExtraKeypointName[];
/** Full Apple Vision body-pose set (19): COCO-17 + neck + root. */
export declare const VISION_KEYPOINT_NAMES: readonly KeypointName[];
