...
exports.EXERCISE_ALIASES = void 0;
exports.resolveExerciseName = resolveExerciseName;
exports.findExerciseByIdOrAlias = findExerciseByIdOrAlias;
exports.EXERCISE_ALIASES = {
    face_squat: 'squat',
    face_pushup: 'push_up',
    face_plank: 'plank',
    face_lunge: 'lunge',
...
function resolveExerciseName(name) {
    return exports.EXERCISE_ALIASES[name] ?? name;
}
/**
 ...
 */
function findExerciseByIdOrAlias(exerciseId, exercises) {
    const exact = exercises.find((e) => e.id === exerciseId);
    if (exact)
        return exact;
    const canonical = resolveExerciseName(exerciseId);
    const legacyIds = Object.entries(exports.EXERCISE_ALIASES)
