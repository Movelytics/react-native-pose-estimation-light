...
exports.anglesToClassicTree = anglesToClassicTree;
exports.toClassicNativeMessage = toClassicNativeMessage;
/** Relation keys matching engine `PUBLIC_ANGLES` / Front `computeAngles`. */
const ANGLE_RELATIONS = {
 ...
 */
function anglesToClassicTree(angles) {
    const data = {
        left_side: {},
        right_side: {},
    };
 ...
 */
function toClassicNativeMessage(event) {
    switch (event.type) {
        case 'initialization':
            return {
                type: 'initialization',
                ...
                message: event.step === 'configuring'
