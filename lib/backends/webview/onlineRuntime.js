...
exports.ONLINE_POSE_DETECTION_VERSION = exports.ONLINE_TFJS_VERSION = void 0;
...
function getOnlineRuntimeParts(options = {}) {
    ...
    if (resolved.kind === 'blazepose') {
        scriptUrls.push(defaultPoseDetectionCdnUrl(options.tfjsCdnBase, options.poseDetectionVersion));
    }
    return {
